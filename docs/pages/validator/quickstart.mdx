...
*The below setup enables you to run the interstate-pbs module and interstate-sidecar via kubernetes helm chart. You are expected to have a running signer (for instructions see signer section) and validator. The helm charts below will connect sidecar to signer.*
